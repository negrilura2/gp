# scripts/eval_threshold.py
"""
Usage:
python -m scripts.eval_threshold --model models/ecapa_best.pth --feature_dir data/features --out_dir reports --max_pairs 20000
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model", default="models/ecapa_best.pth")
